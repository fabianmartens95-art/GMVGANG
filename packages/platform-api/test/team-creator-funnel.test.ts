...
function source(): TeamCreatorFunnelSource {
  return {
    users: [
      ...
      { id: "creator-2", email: "active@example.com", created_at: "2026-09-17T21:50:00.000Z", updated_at: "2026-09-17T21:50:00.000Z" },
      { id: "founder", email: "founder@example.com", created_at: "2026-09-17T19:00:00.000Z", updated_at: "2026-09-17T19:00:00.000Z" },
    ],
    profiles: [
      ...
      { id: "profile-founder", user_id: "founder", tiktok_handle: "test", display_name: "Test", network_status: "profile_complete", profile_completion_percent: 100, created_at: "2026-09-17T19:05:00.000Z", updated_at: "2026-09-17T19:05:00.000Z" },
    ],
    qualifications: [],
    memberships: [
...
describe("team creator funnel read model", () => {
  it("flags incomplete idle creators as stalled and excludes internal staff accounts", () => {
