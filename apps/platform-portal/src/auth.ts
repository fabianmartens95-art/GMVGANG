  ...
  return `
    <main class="auth-page">
      <section class="auth-shell">
        ...
        <p>Du erhältst einen sicheren Login-Link per E-Mail. Ein Portal-Account ist noch keine automatische Aufnahme ins vertragliche GMVGANG Creator Network.</p>
...
export function wireMagicLinkLogin(client: SupabaseClient): void {
  ...
  form.addEventListener("submit", async (event) => {
    ...
    result.innerHTML = "<strong>E-Mail gesendet.</strong> Öffne den Login-Link, um fortzufahren.";
  });
}
...
export async function completeAuthCallback(client: SupabaseClient, url: URL): Promise<AuthCallbackResult> {
