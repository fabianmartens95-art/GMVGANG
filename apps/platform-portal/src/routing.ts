...
export const PORTAL_ROUTES: readonly PortalRoute[] = [
  ...
  { path: "/creator/onboarding", area: "creator", label: "Onboarding", navigation: "module", moduleId: "onboarding" },
  ...
  { path: "/creator/activity", area: "creator", label: "Activity", navigation: "module", moduleId: "activity" },

  { path: "/brand", area: "brand", label: "Brand Portal", navigation: "primary", moduleId: "overview" },
  { path: "/brand/setup", area: "brand", label: "Onboarding", navigation: "module", moduleId: "setup" },
  { path: "/brand/products", area: "brand", label: "Produkte", navigation: "module", moduleId: "products" },
  ...
  { path: "/brand/activity", area: "brand", label: "Activity", navigation: "module", moduleId: "activity" },
