...
import { buildCreatorOnboardingModel, renderCreatorOnboarding as renderCreatorLifecycleOnboarding } from "./creator-onboarding.js";
  ...
  if (area === "creator" && route.moduleId === "overview") {
    ...
    return `
      <main class="workspace">
        ${intro}
        ${renderCreatorLifecycleOnboarding(onboarding)}
